...
public class Stats {
	...
	public String toString() {
		...
		double AverageProfitShort = ((totalShortWinnings - totalShortLoss) / numberShort);

		String s = "\tNumOfTrades:" + numberOfTrades + "," + "\tWinners:" + (numberWinners / numberOfTrades * 100) + "%"
				+ "," + "\tAvrgProfit: " + df.format(AverageProfit) + "," + "\tLongwinners: "
				+ (longWinners / numberLong * 100) + "%" + " ," + "\tAvrgProfitWinner: "
				+ df.format(AverageProfitWinners) + ", " + "\tNumOfShort:" + numberShort + "," + "\tShortwinners: "
				+ (shortWinners / numberShort * 100) + "%" + "," + "\tAvrgProfitShort: "
